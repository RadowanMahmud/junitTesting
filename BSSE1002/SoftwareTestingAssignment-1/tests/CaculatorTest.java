...
public class CaculatorTest {
    ...
    public void multiplyworst25 () {
        Caculator c = new Caculator();
        int result = c.multiply(4,6);
        int expected = 24;
        assertEquals(expected,result);
    }
    @Test
    public void multiplyBVC10000 () {
        Caculator c = new Caculator();
        int result = c.multiply(3,4);
        int expected = 12;
        assertEquals(expected,result);
